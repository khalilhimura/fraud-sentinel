...
Phase 0 and Phase 1 initialization for the Agentic AI mule-account fraud detection demo.
...
| Phase 2: Synthetic generator and ingestion | Not started | Planned after Phase 1 verification. |
...
Phase 2 should implement the synthetic data generator, CSV schema validation, normalization, rejected-row output, and data-quality profiling. Start with a small deterministic fixture and 10,000-row generator run before scaling toward 1,000,000 rows.
